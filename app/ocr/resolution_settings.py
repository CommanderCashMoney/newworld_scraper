...
res_2160p = Resolution(
    name="2160p",
    trading_post=ImageReference(screen_bbox=(686, 57, 205, 60), file_name="trading_post_label.png", min_conf=0.92),
    top_scroll=ImageReference(screen_bbox=(3660, 628, 50, 35), file_name="top_of_scroll.png", min_conf=0.95),
    mid_scroll=ImageReference(screen_bbox=(3665, 2028, 38, 23), file_name="mid_scroll_bottom.png", min_conf=0.95),
    bottom_scroll=ImageReference(screen_bbox=(3659, 1381, 56, 43), file_name="bottom_of_scroll_bottom.png", min_conf=0.95),
    cancel_button=ImageReference(screen_bbox=(1113, 1493, 782, 141), file_name="cancel_btn.png", min_conf=0.95),
    refresh_button=ImageReference(screen_bbox=(2144, 1130, 604, 253), file_name="refresh_btn.png", min_conf=0.95),
    next_page_coords=(3605, 451),
    ...
    tp_tier_col_x_coords=(830, 950-830-5),
    tp_gs_col_x_coords=(950, 1080-950-5),
    tp_gem_col_x_coords=(1080, 1210-1080-5),
    tp_perk_col_x_coords=(1210, 1450-1210-5),
    tp_rarity_col_x_coords=(1450, 1630-1450-5),
    tp_avail_col_x_coords=(1630, 115),
    tp_location_col_x_coords=(2020, 230),

    first_item_listing_bbox=(1260, 669, 316, 98),
    mouse_scroll_loc=(3656, 665),
    sections={
           'Resources Reset 0': (257, 1195),
           'Raw Resources': (584, 722),
           'Resources Reset 1': (257, 1195),
           'Refined Resources': (578, 1276),
           'Resources Reset 2': (257, 1195),
           'Cooking Ingredients': (586, 1064),
           'Resources Reset 3': (257, 1195),
           'Craft Mods': (578, 1496),
           'Resources Reset 4': (257, 1195),
           'Components': (559, 1385),
           'Resources Reset 5': (257, 1195),
           'Potion Reagents': (593, 962),
           'Resources Reset 6': (257, 1195),
           'Dyes': (591, 1167),
           'Resources Reset 7': (257, 1195),
           'Azoth': (581, 1595),
           'Resources Reset 8': (257, 1195),
           'Arcana': (596, 843),
           'Consumables': (249, 1344),
           'Ammunition': (255, 1484),
           'House Furnishings': (249, 1630)
    }
)
