...
res_4k = Resolution(
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(3625, 745, 51, 51), file_name="top_of_scroll.png", min_conf=0.80),
    buy_order_mid_scroll=ImageReference(screen_bbox=(3632, 1792, 39, 39), file_name="mid_scroll_bottom.png", min_conf=0.86),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3633, 1479, 37, 57), file_name="bottom_of_scroll_bottom.png", min_conf=0.75),
    buy_order_cancel_button=ImageReference(screen_bbox=(1451, 1690, 123, 33), file_name="cancel_btn.png", min_conf=0.80),
    buy_order_refresh_button=ImageReference(screen_bbox=(2336, 1418, 235, 34), file_name="refresh_btn.png", min_conf=0.80),
...
res_2560x1080p = Resolution(
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(2137, 373, 18, 19), file_name="top_of_scroll.png", min_conf=0.80),
    ...
    buy_order_bottom_scroll=ImageReference(screen_bbox=(2137, 1034, 13, 19), file_name="buy_order_bottom_of_scroll.png",
                                           min_conf=0.80),
    buy_order_cancel_button=ImageReference(screen_bbox=(1044, 843, 63, 17), file_name="cancel_btn.png", min_conf=0.80),
...
res_1440p = Resolution(
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(2416, 497, 34, 34), file_name="top_of_scroll.png", min_conf=0.80),
    buy_order_mid_scroll=ImageReference(screen_bbox=(2421, 1196, 27, 27), file_name="mid_scroll_bottom.png", min_conf=0.86),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(2421, 987, 25, 38), file_name="bottom_of_scroll_bottom.png", min_conf=0.75),
...
res_1080p = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(1833, 314, 18, 19), file_name="top_of_scroll.png", min_conf=0.80),
    mid_scroll=ImageReference(screen_bbox=(1833, 634, 18, 23), file_name="mid_scroll_bottom.png", min_conf=0.80),
    bottom_scroll=ImageReference(screen_bbox=(1835, 1031, 13, 19), file_name="bottom_of_scroll_bottom.png", min_conf=0.75),
    cancel_button=ImageReference(screen_bbox=(720, 772, 63, 17), file_name="cancel_btn.png", min_conf=0.80),
    refresh_button=ImageReference(screen_bbox=(1163, 676, 120, 19), file_name="refresh_btn.png", min_conf=0.80),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(1817, 373, 18, 19), file_name="top_of_scroll.png", min_conf=0.80),
