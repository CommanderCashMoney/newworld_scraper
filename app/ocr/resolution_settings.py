...
res_4k = Resolution(
    ...
    buy_order_mid_scroll=ImageReference(screen_bbox=(3632, 1792, 39, 39), file_name="mid_scroll_bottom.png", min_conf=0.95),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3633, 1479, 37, 57), file_name="bottom_of_scroll_bottom.png", min_conf=0.95),
