...
res_4k = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(3657, 627, 51, 51), file_name="top_of_scroll.png", min_conf=0.90),
    mid_scroll=ImageReference(screen_bbox=(3664, 1971, 39, 39), file_name="mid_scroll_bottom.png", min_conf=0.90),
    bottom_scroll=ImageReference(screen_bbox=(3665, 1372, 37, 57), file_name="bottom_of_scroll_bottom.png", min_conf=0.90),
    ...
    menu_loc=(3738, 113),
    exit_to_desk_loc=(2648, 1326),
    yes_button_loc=(2195, 1296),
    resources_reset_loc=(255, 1194),
    sort_up_arrow=ImageReference(screen_bbox=(1974, 589, 25, 37), file_name="sort_up_arrow.png", min_conf=0.90),
    # --------Sold Orders ----------------
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(3625, 745, 51, 51), file_name="top_of_scroll.png", min_conf=0.90),
    buy_order_mid_scroll=ImageReference(screen_bbox=(3632, 1792, 39, 39), file_name="mid_scroll_bottom.png", min_conf=0.86),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3633, 1479, 37, 57), file_name="bottom_of_scroll_bottom.png", min_conf=0.90),
    buy_order_cancel_button=ImageReference(screen_bbox=(1451, 1690, 123, 33), file_name="cancel_btn.png", min_conf=0.90),
    ...
    buy_order_sort_down_arrow=ImageReference(screen_bbox=(1974, 589, 25, 37), file_name="sort_up_arrow.png", min_conf=0.90),
...
res_2560x1080p = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(2153, 314, 18, 19), file_name="top_of_scroll.png", min_conf=0.90),
    mid_scroll=ImageReference(screen_bbox=(2153, 634, 18, 23), file_name="mid_scroll_bottom.png", min_conf=0.90),
    bottom_scroll=ImageReference(screen_bbox=(2155, 1031, 13, 19), file_name="bottom_of_scroll_bottom.png",
                                 min_conf=0.90),
    cancel_button=ImageReference(screen_bbox=(1041, 773, 63, 17), file_name="cancel_btn.png", min_conf=0.90),
    ...
    menu_loc=(2189, 53),
    exit_to_desk_loc=(1645, 664),
    yes_button_loc=(1423, 649),
    sort_up_arrow=ImageReference(screen_bbox=(1307, 294, 13, 19), file_name="sort_up_arrow.png", min_conf=0.90),
    # --------Sold Orders ----------------
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(2137, 373, 18, 19), file_name="top_of_scroll.png", min_conf=0.90),
    ...
    buy_order_bottom_scroll=ImageReference(screen_bbox=(2137, 1034, 13, 19), file_name="buy_order_bottom_of_scroll.png",
                                           min_conf=0.90),
    buy_order_cancel_button=ImageReference(screen_bbox=(1044, 843, 63, 17), file_name="cancel_btn.png", min_conf=0.90),
