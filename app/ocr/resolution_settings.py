...
res_5120x1440p = Resolution(
    ...
    server_name_bbox=(4922, 1015, 185, 33),
    ...
    bottom_scroll=ImageReference(screen_bbox=(3723, 915, 25, 38), file_name="bottom_of_scroll_bottom.png",
                                 min_conf=0.95),
    cancel_button=ImageReference(screen_bbox=(2241, 1032, 90, 30), file_name="cancel_btn.png", min_conf=0.80),
    refresh_button=ImageReference(screen_bbox=(2823, 900, 170, 40), file_name="refresh_btn.png", min_conf=0.80),
    next_page_coords=(3680, 300),
    pages_bbox=(3615, 293, 54, 17),
    current_page_bbox=(3501, 292, 112, 21),
    items_bbox=(2207, 430, 1510, 919),
    items_bbox_last=(2207, 1198, 1510, 200),
    tp_row_height=256,
    ...
    first_item_listing_bbox=(2122, 444, 200, 70),
    mouse_scroll_loc=(3711, 438),
    menu_loc=(3755, 57),
    exit_to_desk_loc=(4300, 1016),
    yes_button_loc=(2743, 864),
    resources_reset_loc=(1450, 796),
    sort_up_arrow=ImageReference(screen_bbox=(2596, 392, 17, 25), file_name="sort_up_arrow.png", min_conf=0.80),
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(3666, 514, 17, 55), file_name="top_of_scroll.png", min_conf=0.98),
    sold_order_bottom_scroll=ImageReference(screen_bbox=(3672, 1342, 12, 14), file_name="sold_order_bottom_scroll.png",
                                            min_conf=0.90),
    sold_order_items_bbox=(2037, 523, 1601, 709),
    sold_order_items_full_bbox=(2037, 523, 1616, 812),
    ...
    sold_order_completed_tab=(2113, 397),
    sold_order_sold_items_tab=(1662, 557),
    sold_order_mouse_scroll_loc=(3650, 528),
    sold_order_price_sort_down=ImageReference(screen_bbox=(2356, 483, 17, 25),
                                              file_name="sold_order_price_sort_down.png", min_conf=0.70),
    # --------Buy Orders ----------------
    sell_tab_coords=(2034, 210),
    buy_order_all_items=(2265, 308),
    buy_order_top_scroll=ImageReference(screen_bbox=(3708, 502, 17, 55), file_name="top_of_scroll.png", min_conf=0.981),
    buy_order_mid_scroll=ImageReference(screen_bbox=(3701, 1196, 27, 27), file_name="mid_scroll_bottom.png",
                                        min_conf=0.90),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3701, 987, 25, 38), file_name="bottom_of_scroll_bottom.png",
                                           min_conf=0.94),
    buy_order_cancel_button=ImageReference(screen_bbox=(2245, 1125, 90, 30), file_name="cancel_btn.png", min_conf=0.80),
    buy_order_refresh_button=ImageReference(screen_bbox=(2838, 946, 170, 40), file_name="refresh_btn.png",
                                            min_conf=0.80),
    buy_order_next_page_coords=(3659, 411),
    buy_order_pages_bbox=(3590, 398, 34, 19),
    buy_order_current_page_bbox=(3477, 398, 107, 21),
    buy_order_items_bbox=(2229, 508, 1468, 714),
    buy_order_items_bbox_last=(2229, 786, 1468, 612),
    ...
    buy_order_first_item_listing_bbox=(2150, 516, 200, 70),
    buy_order_mouse_scroll_loc=(3692, 523),
    buy_order_all_items_tab=(2283, 311),
    buy_order_sort_down_arrow=ImageReference(screen_bbox=(2568, 471, 17, 25), file_name="sort_up_arrow.png",
                                             min_conf=0.80),
    ...
    sections={
           'Raw Resources': ((1648, 488), True),
           'Arcana': ((1648, 568), True),
           'Potion Reagents': ((1648, 632), True),
           'Cooking Ingredients': ((1648, 708), True),
           'Dye Ingredients': ((1648, 788), True),
           'Refined Resources': ((1648, 855), True),
           'Components': ((1648, 936), True),
           'Craft Mods': ((1648, 990), True),
           'Azoth': ((1648, 1068), True),
           'Runeglass Components': ((1648, 1140), True),
           'Consumables': ((1445, 900), False),
           'Ammunition': ((1445, 985), False),
           'House Furnishings': ((1445, 1091), False),
           'Buy Orders': ((2034, 210), False),
           'Sold Items': ((2463, 207), False),
       },
    buy_order_sections={
            'Buy Order - Resources': ((1480, 901), False),
            'Buy Order - Consumables': ((1475, 1005), False),
            'Buy Order - Ammunition': ((1475, 1090), False),
            'Buy Order - House Furnishings': ((1475, 1196), False),
    },
)
...
res_4k = Resolution(
    ...
    bottom_scroll=ImageReference(screen_bbox=(3665, 1372, 37, 57), file_name="bottom_of_scroll_bottom.png", min_conf=0.95),
    ...
    current_page_bbox=(3332, 438, 168, 32),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(3587, 768, 18, 51), file_name="top_of_scroll.png", min_conf=0.97),
    sold_order_bottom_scroll=ImageReference(screen_bbox=(3588, 2013, 18, 21), file_name="sold_order_bottom_scroll.png", min_conf=0.90),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(3651, 750, 18, 51), file_name="buyorder_top_of_scroll.png", min_conf=0.97),
    buy_order_mid_scroll=ImageReference(screen_bbox=(3650, 1205, 18, 45), file_name="buyorder_mid_scroll_top.png", min_conf=0.95),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3650, 2065, 18, 55), file_name="buyorder_bottom_of_scroll_bottom.png", min_conf=0.95),
...
res_2560x1080p = Resolution(
    ...
    server_name_bbox=(2414, 760, 150, 24),
    ...
    bottom_scroll=ImageReference(screen_bbox=(2161, 690, 9, 42), file_name="top_of_scroll_bottom.png",
                                 min_conf=0.70),
    ...
    current_page_bbox=(1986, 219, 84, 16),
    ...
    buy_order_mid_scroll=ImageReference(screen_bbox=(2137, 600, 18, 23), file_name="mid_scroll_bottom.png",
                                        min_conf=0.91),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(2145, 744, 9, 42), file_name="top_of_scroll_bottom.png",
                                           min_conf=0.91),
...
res_1440p = Resolution(
    ...
    # trading_post=ImageReference(screen_bbox=(450, 32, 165, 64), file_name="trading_post_label.png", min_conf=0.80),
    # my_orders_clip_icon=ImageReference(screen_bbox=(1056, 192, 20, 22), file_name="my_orders_clip_icon.png", min_conf=0.70),
    server_name_bbox=(2382, 1015, 170, 33),
    ...
    current_page_bbox=(2221, 292, 112, 21),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(2392, 492, 17, 55), file_name="top_of_scroll.png", min_conf=0.98),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(2434, 480, 17, 55), file_name="top_of_scroll.png", min_conf=0.98),
...
res_3440x1440p = Resolution(
    ...
    bottom_scroll=ImageReference(screen_bbox=(2883, 915, 25, 38), file_name="bottom_of_scroll_bottom.png",
                                 min_conf=0.95),
    cancel_button=ImageReference(screen_bbox=(1401, 1032, 90, 30), file_name="cancel_btn.png", min_conf=0.80),
    refresh_button=ImageReference(screen_bbox=(1983, 900, 170, 40), file_name="refresh_btn.png", min_conf=0.80),
    next_page_coords=(2840, 300),
    pages_bbox=(2775, 293, 54, 17),
    current_page_bbox=(2661, 292, 112, 21),
    items_bbox=(1367, 430, 1950, 919),
    items_bbox_last=(1367, 1198, 1950, 200),
    tp_row_height=256,
    tp_name_col_x_coords=(0, 380),
    tp_price_col_x_coords=(380, 550),
    tp_avail_col_x_coords=(1320, 1440),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(2832, 492, 17, 55), file_name="top_of_scroll.png", min_conf=0.97),
    ...
    sold_order_items_full_bbox=(1197, 523, 2056, 812),
    sold_order_tp_name_col_x_coords=(0, 316),
    sold_order_tp_price_col_x_coords=(316, 439),
    sold_order_qty_col_x_coords=(439, 563),
    sold_order_sold_qty_col_x_coords=(563, 686),
    ...
    sold_order_tp_status_col_x_coords=(1057, 1238),
    sold_order_tp_completion_time_col_x_coords=(1238, 1428),
    sold_order_completed_tab=(1273, 397),
    sold_order_sold_items_tab=(822, 557),
    sold_order_mouse_scroll_loc=(2810, 528),
    sold_order_price_sort_down=ImageReference(screen_bbox=(1516, 483, 17, 25),
                                              file_name="sold_order_price_sort_down.png", min_conf=0.70),
    # --------Buy Orders ----------------
    sell_tab_coords=(1194, 210),
    buy_order_all_items=(1425, 308),
    buy_order_top_scroll=ImageReference(screen_bbox=(2875, 480, 17, 55), file_name="top_of_scroll.png", min_conf=0.97),
    ...
    buy_order_bottom_scroll=ImageReference(screen_bbox=(2861, 987, 25, 38), file_name="bottom_of_scroll_bottom.png",
                                           min_conf=0.95),
    buy_order_cancel_button=ImageReference(screen_bbox=(1407, 1127, 90, 30), file_name="cancel_btn.png", min_conf=0.80),
    buy_order_refresh_button=ImageReference(screen_bbox=(1998, 946, 170, 40), file_name="refresh_btn.png",
                                            min_conf=0.80),
    buy_order_next_page_coords=(2819, 411),
    buy_order_pages_bbox=(2750, 398, 34, 19),
    buy_order_current_page_bbox=(2637, 398, 107, 21),
    buy_order_items_bbox=(1389, 508, 1908, 714),
    buy_order_items_bbox_last=(1389, 786, 1908, 612),
    buy_order_tp_row_height=256,
    buy_order_tp_name_col_x_coords=(0, 336),
    buy_order_tp_price_col_x_coords=(336, 548),
    buy_order_tp_tier_col_x_coords=(548, 665),
    ...
    buy_order_tp_gem_col_x_coords=(1145, 1279),
    buy_order_tp_qty_col_x_coords=(1279, 1413),
    buy_order_first_item_listing_bbox=(1310, 516, 200, 70),
    buy_order_mouse_scroll_loc=(2852, 523),
    buy_order_all_items_tab=(1443, 311),
    buy_order_sort_down_arrow=ImageReference(screen_bbox=(1728, 471, 17, 25), file_name="sort_up_arrow.png",
                                             min_conf=0.80),
    # ------------------------------------
    # False and True indicate if a resource reset is needed before starting this section
    # buy_order_adjustment=(30, 105),  # add this to the loc of the section below to get the loc for buy orders
    sections={
        'Raw Resources': ((808, 488), True),
        'Arcana': ((808, 568), True),
        'Potion Reagents': ((808, 632), True),
        'Cooking Ingredients': ((808, 708), True),
        'Dye Ingredients': ((808, 788), True),
        'Refined Resources': ((808, 855), True),
        'Components': ((808, 936), True),
        'Craft Mods': ((808, 990), True),
        'Azoth': ((808, 1068), True),
        'Runeglass Components': ((808, 1140), True),
        'Consumables': ((605, 900), False),
        'Ammunition': ((605, 985), False),
        'House Furnishings': ((605, 1091), False),
        'Buy Orders': ((1194, 210), False),
        'Sold Items': ((1623, 207), False),
    },
    buy_order_sections={
        'Buy Order - Resources': ((640, 901), False),
        'Buy Order - Consumables': ((635, 1005), False),
        'Buy Order - Ammunition': ((635, 1090), False),
        'Buy Order - House Furnishings': ((635, 1196), False),
    },
)
...
res_1080p = Resolution(
    ...
    # trading_post=ImageReference(screen_bbox=(338, 31, 96, 24), file_name="trading_post_label.png", min_conf=0.80),
    # my_orders_clip_icon=ImageReference(screen_bbox=(792, 144, 15, 17), file_name="my_orders_clip_icon.png", min_conf=0.70),
    server_name_bbox=(1775, 760, 150, 25),
    ...
    bottom_scroll=ImageReference(screen_bbox=(1841, 690, 9, 42), file_name="top_of_scroll_bottom.png",
                                 min_conf=0.70),
    ...
    current_page_bbox=(1666, 219, 84, 16),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(1826, 374, 9, 31), file_name="top_of_scroll.png", min_conf=0.91),
    buy_order_mid_scroll=ImageReference(screen_bbox=(1817, 600, 18, 23), file_name="mid_scroll_bottom.png",
                                        min_conf=0.91),
    buy_order_bottom_scroll=ImageReference(screen_bbox=(1826, 744, 9, 42), file_name="top_of_scroll_bottom.png",
                                           min_conf=0.91),
