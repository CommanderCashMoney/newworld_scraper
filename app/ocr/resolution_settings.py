...
res_5120x1440p = Resolution(
    ...
    buy_icon=ImageReference(screen_bbox=(1529, 191, 30, 22), file_name="buy_icon.png", min_conf=0.70),
    top_scroll=ImageReference(screen_bbox=(3735, 401, 12, 34), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    current_page_bbox=(3501, 292, 107, 21),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(3671, 512, 12, 14), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(3713, 500, 12, 14), file_name="top_of_scroll.png", min_conf=0.96),
    ...
    buy_order_bottom_scroll=ImageReference(screen_bbox=(3701, 987, 25, 38), file_name="bottom_of_scroll_bottom.png",
                                           min_conf=0.94),
    buy_order_cancel_button=ImageReference(screen_bbox=(2247, 1127, 90, 30), file_name="cancel_btn.png", min_conf=0.80),
    ...
    sections={
           ...
           'Consumables': ((1648, 900), False),
           'Ammunition': ((1648, 985), False),
           'House Furnishings': ((1648, 1091), False),
...
res_4k = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(3683, 602, 18, 51), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(3587, 768, 18, 21), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(3651, 750, 18, 21), file_name="top_of_scroll.png", min_conf=0.70),
...
res_1440p = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(2455, 401, 12, 34), file_name="top_of_scroll.png", min_conf=0.95),
...
res_3440x1440p = Resolution(
    ...
    top_scroll=ImageReference(screen_bbox=(2895, 421, 12, 14), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    current_page_bbox=(2661, 292, 107, 21),
    ...
    # --------Sold Orders ----------------
    sold_order_top_scroll=ImageReference(screen_bbox=(2831, 512, 12, 14), file_name="top_of_scroll.png", min_conf=0.95),
    ...
    buy_order_top_scroll=ImageReference(screen_bbox=(2873, 500, 12, 14), file_name="top_of_scroll.png", min_conf=0.96),
